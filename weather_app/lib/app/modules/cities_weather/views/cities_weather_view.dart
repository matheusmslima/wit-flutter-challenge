...
class CitiesWeatherView extends GetView<CitiesWeatherController> {
  @override
  var controller = Get.put(CitiesWeatherController());

  CitiesWeatherView({Key? key}) : super(key: key);
  @override
        ...
        Row(
          ...
          children: [
            TextButton(
              ...
              onPressed: () {
                controller.onRefreshController();
              },
            ),
          ],
        ),
